...
optimizer.set_Replaybuff(replaybuff,128,0.99,1e-4,1e-3,4800)
...
Criticm=Critic_PPO(4,24,1).to(device)
...
while True:
    ...
    observation, reward, terminated, truncated, _ = envnow.step(action)
    total_reward+=reward
